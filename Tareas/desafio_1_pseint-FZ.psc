Algoritmo modulo_subprocesos
	...
	Para i<-1 Hasta cant_cursos Con Paso 1 Hacer
		...
		Para j<-1 Hasta cant_notas Con Paso 1 Hacer
			...
			//comprobar si la nota fue bien ingresada			
			Mientras mis_notas[i,j] <1.0 O mis_notas[i,j]>7.0 Hacer
				Escribir "Error. Ingrese nuevamenta la Nota " + ConvertirATexto(j) Sin Saltar
				Leer mis_notas[i,j]
			Fin Mientras
		Fin Para
	Fin Para
	
	//--- calcular promedio, generar reporte
	Escribir ""
	Escribir "****************************"
	Escribir "******** MI REPORTE ********"
	Escribir "****************************"
